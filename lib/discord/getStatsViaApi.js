 ...
 */
export async function fetchDiscordStatsViaApi({ guildId, token, backfill = false, backfillYear = new Date().getFullYear() }) {
  ...
  const url = `/api/discord/engagement?${params.toString()}`;
