...
const OUTPUT_FILE =
    ...
    path.resolve(process.cwd(), 'data/discord-stats/client-test-stats.json')
...
client.once('ready', async () => {
    ...
    console.log(`  Text channels: ${allTextChannels.length}`)
    ...
    console.log(`  Processed months: ${Object.keys(ordered).length}`)
